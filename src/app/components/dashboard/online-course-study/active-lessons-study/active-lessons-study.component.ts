...
@Component({
  selector: 'app-active-lessons-study',
  templateUrl: './active-lessons-study.component.html',
  styleUrls: ['./active-lessons-study.component.scss']
})
export class ActiveLessonsStudyComponent {
