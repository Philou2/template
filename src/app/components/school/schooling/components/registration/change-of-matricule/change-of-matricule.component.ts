...
import {ChangeOfMatriculeAddEditComponent} from './change-of-matricule-add-edit/change-of-matricule-add-edit.component';

@Component({
  selector: 'app-change-of-matricule',
  templateUrl: './change-of-matricule.component.html',
  styleUrls: ['./change-of-matricule.component.scss']
})
export class ChangeOfMatriculeComponent implements OnInit {
  ...
  editMatricule(data: any) {
    console.log(data);
    const modalRef = this.modalService.open(ChangeOfMatriculeAddEditComponent,
        {
          centered: true,
          // backdrop: 'static'
        }
