...
import {ChangeOfClassAddEditComponent} from './change-of-class-add-edit/change-of-class-add-edit.component';

@Component({
  selector: 'app-change-of-class',
  templateUrl: './change-of-class.component.html',
  styleUrls: ['./change-of-class.component.scss']
})
export class ChangeOfClassComponent implements OnInit {
  ...
  editClass(data: any) {
    console.log(data);
    const modalRef = this.modalService.open(ChangeOfClassAddEditComponent,
        {
          centered: true,
          // backdrop: 'static'
        }
