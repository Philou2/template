...
import {ReadmissionAddEditComponent} from './readmission-add-edit/readmission-add-edit.component';
...
export class ReadmissionComponent implements OnInit {
  ...
  addReAdmission() {
    const modalRef = this.modalService.open(ReadmissionAddEditComponent);
