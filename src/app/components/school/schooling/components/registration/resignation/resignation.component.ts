...
import {ResignationAddEditComponent} from './resignation-add-edit/resignation-add-edit.component';
...
export class ResignationComponent implements OnInit {
  ...
  getStudRegistrationList(): any {
    this.studRegistrationService.getResignation().subscribe({
      next: (res: any) => {
        console.log(res);
        ...
        // this.studRegistrations = this.studRegistrations.filter(studRegistrations => studRegistrations.status === 'resigned');

        console.log(this.studRegistrations);
        console.log(this.studRegistrations[0]);
        console.log(res);
  ...
  addResignation() {
    const modalRef = this.modalService.open(ResignationAddEditComponent);
