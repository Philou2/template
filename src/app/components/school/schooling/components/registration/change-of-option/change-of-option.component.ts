...
import {ChangeOfOptionAddEditComponent} from './change-of-option-add-edit/change-of-option-add-edit.component';

@Component({
  selector: 'app-change-of-option',
  templateUrl: './change-of-option.component.html',
  styleUrls: ['./change-of-option.component.scss']
})
export class ChangeOfOptionComponent implements OnInit {
  ...
  editOption(data: any) {
    console.log(data);
    const modalRef = this.modalService.open(ChangeOfOptionAddEditComponent,
        {
          centered: true,
          // backdrop: 'static'
        }
