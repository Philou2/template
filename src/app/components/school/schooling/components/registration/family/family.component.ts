...
export class FamilyComponent implements OnInit {
  ...
  constructor(public familyService: FamilyService, config: NgbModalConfig,
  ...
  getFamilyList(): any {
    this.familyService.getCollection().subscribe({
      next: (res: any) => {
        this.families = res['hydra:member'];
  ...
  addFamily() {
    const modalRef = this.modalService.open(FamilyAddEditComponent, {
      centered: true,
    });
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.familyService.delete(id).subscribe({
          next: (res) => {
            this.toastr.success('Family successfully deleted', 'Success');
            this.getFamilyList();
          },
          error: (res) => {
            this.loadingIndicator = false;
  ...
  deleteSelectedFamilyRows() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.familyService.deleteMultiple(ids).subscribe({
          next: (res) => {
            console.log(res);
            this.toastr.success('Families deleted !', 'Success');
            this.getFamilyList();
            this.remove();
          },
          error: (err: any) => {
