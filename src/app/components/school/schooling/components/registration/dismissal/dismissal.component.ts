...
import {DismissalAddEditComponent} from './dismissal-add-edit/dismissal-add-edit.component';
...
export class DismissalComponent implements OnInit {
  ...
  getStudRegistrationList(): any {
    this.studRegistrationService.getDismissal().subscribe({
      next: (res: any) => {
        console.log(res);
  ...
  addDismissal() {
    const modalRef = this.modalService.open(DismissalAddEditComponent);
