...
export class MinistryComponent implements OnInit {
  ...
  constructor(public ministryService: MinistryService, config: NgbModalConfig,
  ...
  getMinistrylist(): any
  {
    this.ministryService.getCollection().subscribe({
      next: (res: any) => {
        console.log(res);
  ...
  addMinistry() {
    const modalRef = this.modalService.open(MinistryAddEditComponent);
  ...
  deleteSelectedMinistryRows() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.ministryService.deleteMultiple(ids).subscribe({
          next: (res) => {
            console.log(res);
