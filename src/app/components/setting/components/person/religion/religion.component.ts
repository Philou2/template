...
export class ReligionComponent implements OnInit {
  ...
  constructor(public religionService: ReligionService, config: NgbModalConfig,
  ...
  getReligionlist(): any
  {
    this.religionService.getCollection().subscribe({
      next: (res: any) => {
        console.log(res);
        this.religions = res['hydra:member'];
  ...
  addReligion() {
    const modalRef = this.modalService.open(ReligionAddEditComponent);
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.religionService.delete(id).subscribe({
          next: (res) => {
            this.toastr.success('Religion successful deleted', 'Success');
            this.getReligionlist();
          },
          error: (res) => {
            this.loadingIndicator = false;
  ...
  deleteSelectedReligionRows() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.religionService.deleteMultiple(ids).subscribe({
          next: (res) => {
            console.log(res);
